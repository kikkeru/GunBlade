...
public:
	...
	virtual void Render(std::function<void()> render,  std::function<void()> draw2d=nullptr,bool update_shadow=true) = 0;
	...
	void SetGray(bool f) { m_gray_effect = f; }
...
public:
	...
	~CFowardRendering();
	void Render(std::function<void()> render, std::function<void()> draw2d=nullptr,bool update_shadow=true);
