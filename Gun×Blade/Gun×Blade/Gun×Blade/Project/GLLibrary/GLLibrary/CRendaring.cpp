...
CRendaring::CRendaring(int screen_width, int screen_height, CVector3D focus) : m_width(screen_width), m_height(screen_height), m_focus(focus), m_edge(false), m_dof(false), m_gray_effect(false)
{
...
void CFowardRendering::Render(std::function<void()> render, std::function<void()> draw2d,bool update_shadow)
{
...
void CDeferredRendaring::Render(std::function<void()> render, std::function<void()> draw2d,bool update_shadow)
{
